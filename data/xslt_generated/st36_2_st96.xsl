...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.wipo.int/standards/XMLSchema/ST96/Patent" xmlns:pat="http://www.wipo.int/standards/XMLSchema/ST96/Patent" xmlns:com="http://www.wipo.int/standards/XMLSchema/ST96/Common">
  ...
  <xsl:template match="/patent-document">
    ...
    <xsl:apply-templates select="patent-document/bibliographic-data"/>
    <xsl:apply-templates select="bibliographic-data/@id"/>
    <xsl:apply-templates select="bibliographic-data/@country"/>
    <xsl:apply-templates select="bibliographic-data/plain-language-designation"/>
    <xsl:apply-templates select="bibliographic-data/plain-language-designation/@lang"/>
    <xsl:apply-templates select="bibliographic-data/publication-reference"/>
    <xsl:apply-templates select="bibliographic-data/classification-ipc"/>
    <xsl:apply-templates select="bibliographic-data/classifications-ipcr"/>
    <xsl:apply-templates select="bibliographic-data/classifications-ipcr/classification-ipcr"/>
    <xsl:apply-templates select="bibliographic-data/classification-national"/>
    <xsl:apply-templates select="bibliographic-data/classification-locarno"/>
    <xsl:apply-templates select="bibliographic-data/application-reference"/>
    <xsl:apply-templates select="bibliographic-data/language-of-filing"/>
    <xsl:apply-templates select="bibliographic-data/language-of-publication"/>
    <xsl:apply-templates select="bibliographic-data/priority-claims"/>
    <xsl:apply-templates select="bibliographic-data/parties"/>
    <xsl:apply-templates select="bibliographic-data/designation-of-states"/>
    <xsl:apply-templates select="bibliographic-data/invention-title"/>
    <xsl:apply-templates select="bibliographic-data/assignees"/>
    <xsl:apply-templates select="bibliographic-data/licensee-data"/>
    <xsl:apply-templates select="bibliographic-data/date-of-earliest-priority"/>
    <xsl:apply-templates select="bibliographic-data/date-complete-specification-filed"/>
    <xsl:apply-templates select="bibliographic-data/dates-of-public-availability"/>
    <xsl:apply-templates select="bibliographic-data/term-of-grant"/>
    <xsl:apply-templates select="bibliographic-data/dates-rights-effective"/>
    <xsl:apply-templates select="bibliographic-data/patent-family"/>
    <xsl:apply-templates select="bibliographic-data/field-of-search"/>
    <xsl:apply-templates select="bibliographic-data/figures"/>
    <xsl:apply-templates select="bibliographic-data/references-cited"/>
    <xsl:apply-templates select="bibliographic-data/examiners"/>
    <xsl:apply-templates select="bibliographic-data/number-of-claims"/>
    <xsl:apply-templates select="bibliographic-data/related-documents"/>
    <xsl:apply-templates select="bibliographic-data/st50-republication"/>
    <xsl:apply-templates select="bibliographic-data/date-exhibition-filed"/>
    <xsl:apply-templates select="bibliographic-data/date-pct-article-22-39-fulfilled/date"/>
    <xsl:apply-templates select="bibliographic-data/bio-deposit"/>
    <xsl:apply-templates select="bibliographic-data/pct-or-regional-filing-data"/>
    <xsl:apply-templates select="bibliographic-data/pct-or-regional-publishing-data"/>
    <xsl:apply-templates select="bibliographic-data/date-rights-reestablished"/>
    <xsl:apply-templates select="bibliographic-data/date-application-withdrawn-by-applicant"/>
    <xsl:apply-templates select="bibliographic-data/date-application-deemed-withdrawn"/>
    <xsl:apply-templates select="bibliographic-data/date-of-revocation"/>
    <xsl:apply-templates select="bibliographic-data/date-application-partially-withdrawn/date"/>
    <xsl:apply-templates select="bibliographic-data/opposition-data"/>
    ...
    <xsl:apply-templates select="publication-reference/@id"/>
    <xsl:apply-templates select="publication-reference/document-id/country"/>
    <xsl:apply-templates select="publication-reference/document-id/doc-number"/>
    <xsl:apply-templates select="publication-reference/document-id/kind"/>
    <xsl:apply-templates select="publication-reference/document-id/date"/>
    ...
    <xsl:apply-templates select="licensee-data/attorney-or-agent"/>
    <xsl:apply-templates select="licensee-data/attorney-or-agent/@rep-type"/>
    <xsl:apply-templates select="licensee-data/attorney-or-agent/addressbook"/>
    ...
    <xsl:apply-templates select="related-documents"/>
    <xsl:apply-templates select="related-documents/addition"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc/document-id"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc/parent-status"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc/parent-grant-document/document-id"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc/parent-pct-document"/>
    <xsl:apply-templates select="related-documents/addition/relation/parent-doc/parent-pct-document/document-id"/>
    <xsl:apply-templates select="related-documents/addition/relation/child-doc"/>
    <xsl:apply-templates select="related-documents/addition/relation/child-doc/document-id"/>
    <xsl:apply-templates select="related-documents/division"/>
    <xsl:apply-templates select="related-documents/continuation"/>
    <xsl:apply-templates select="related-documents/continuation/relation/parent-doc/document-id"/>
    <xsl:apply-templates select="related-documents/continuation/relation/parent-doc/document-id/country"/>
    <xsl:apply-templates select="related-documents/continuation/relation/parent-doc/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/continuation/relation/child-doc"/>
    <xsl:apply-templates select="related-documents/continuation/relation/child-doc/document-id"/>
    <xsl:apply-templates select="related-documents/continuation/relation/child-doc/document-id/country"/>
    <xsl:apply-templates select="related-documents/continuation/relation/child-doc/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/continuation-in-part"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/document-id"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/document-id/country"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/document-id/date"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-status"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-grant-document/document-id"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-grant-document/document-id/country"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-grant-document/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-grant-document/document-id/kind"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/parent-doc/parent-grant-document/document-id/date"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/child-doc"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/child-doc/document-id"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/child-doc/document-id/country"/>
    <xsl:apply-templates select="related-documents/continuation-in-part/relation/child-doc/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/continuing-reissue"/>
    <xsl:apply-templates select="related-documents/reissue"/>
    <xsl:apply-templates select="related-documents/reexamination"/>
    <xsl:apply-templates select="related-documents/substitution"/>
    <xsl:apply-templates select="related-documents/utility-model-basis"/>
    <xsl:apply-templates select="related-documents/correction"/>
    <xsl:apply-templates select="related-documents/related-publication"/>
    <xsl:apply-templates select="related-documents/related-publication/document-id"/>
    <xsl:apply-templates select="related-documents/related-publication/document-id/country"/>
    <xsl:apply-templates select="related-documents/related-publication/document-id/doc-number"/>
    <xsl:apply-templates select="related-documents/related-publication/document-id/kind"/>
    <xsl:apply-templates select="related-documents/related-publication/document-id/date"/>
    ...
    <xsl:apply-templates select="parties/applicants"/>
    <xsl:apply-templates select="parties/applicants/applicant"/>
    <xsl:apply-templates select="parties/applicants/applicant/@sequence"/>
    <xsl:apply-templates select="parties/applicants/applicant/@app-type"/>
    <xsl:apply-templates select="parties/applicants/applicant/@designation"/>
    <xsl:apply-templates select="parties/applicants/applicant/addressbook"/>
    <xsl:apply-templates select="parties/applicants/applicant/nationality/country"/>
    <xsl:apply-templates select="parties/applicants/applicant/residence/country"/>
    <xsl:apply-templates select="parties/applicants/applicant/us-rights"/>
    <xsl:apply-templates select="parties/applicants/applicant/us-rights/@kind"/>
    <xsl:apply-templates select="parties/applicants/applicant/us-rights/text()"/>
    <xsl:apply-templates select="parties/inventors"/>
    <xsl:apply-templates select="parties/inventors/inventor"/>
    <xsl:apply-templates select="parties/inventors/inventor/@sequence"/>
    <xsl:apply-templates select="parties/inventors/inventor/@designation"/>
    <xsl:apply-templates select="parties/inventors/inventor/addressbook"/>
    <xsl:apply-templates select="parties/inventors/inventor/designated-states"/>
    <xsl:apply-templates select="parties/inventors/inventor/designated-states/country"/>
    <xsl:apply-templates select="parties/inventors/inventor/designated-states/region"/>
    <xsl:apply-templates select="parties/inventors/inventor/designated-states/region/country"/>
    <xsl:apply-templates select="parties/correspondence-address"/>
    <xsl:apply-templates select="parties/correspondence-address/customer-number"/>
    <xsl:apply-templates select="parties/correspondence-address/addressbook"/>
    <xsl:apply-templates select="parties/agents"/>
    <xsl:apply-templates select="parties/agents/customer-number"/>
    <xsl:apply-templates select="parties/agents/agent"/>
    <xsl:apply-templates select="parties/agents/agent/@sequence"/>
    <xsl:apply-templates select="parties/agents/agent/@rep-type"/>
    <xsl:apply-templates select="parties/agents/agent/addressbook"/>
    ...
    <xsl:apply-templates select="patent-document/@lang"/>
    <xsl:apply-templates select="patent-document/@file"/>
    <xsl:apply-templates select="patent-document/@file-reference-id"/>
    <xsl:apply-templates select="patent-document/@country"/>
    <xsl:apply-templates select="patent-document/@status"/>
    <xsl:apply-templates select="patent-document/doc-page"/>
    <xsl:apply-templates select="patent-document/description"/>
    <xsl:apply-templates select="patent-document/description/@id"/>
    <xsl:apply-templates select="patent-document/description/@lang"/>
    <xsl:apply-templates select="patent-document/description/doc-page"/>
    <xsl:apply-templates select="patent-document/description/invention-title"/>
    <xsl:apply-templates select="patent-document/description/technical-field"/>
    <xsl:apply-templates select="patent-document/description/technical-field/@id"/>
    <xsl:apply-templates select="patent-document/description/technical-field/heading"/>
    <xsl:apply-templates select="patent-document/description/technical-field/p"/>
    <xsl:apply-templates select="patent-document/description/background-art"/>
    <xsl:apply-templates select="patent-document/description/background-art/@id"/>
    <xsl:apply-templates select="patent-document/description/background-art/heading"/>
    <xsl:apply-templates select="patent-document/description/background-art/p"/>
    <xsl:apply-templates select="patent-document/description/disclosure"/>
    <xsl:apply-templates select="patent-document/description/disclosure/@id"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-problem"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-problem/@id"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-problem/heading"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-problem/p"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-solution"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-solution/@id"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-solution/heading"/>
    <xsl:apply-templates select="patent-document/description/disclosure/tech-solution/p"/>
    <xsl:apply-templates select="patent-document/description/disclosure/advantageous-effects"/>
    <xsl:apply-templates select="patent-document/description/disclosure/advantageous-effects/@id"/>
    <xsl:apply-templates select="patent-document/description/disclosure/advantageous-effects/heading"/>
    <xsl:apply-templates select="patent-document/description/disclosure/advantageous-effects/p"/>
    <xsl:apply-templates select="patent-document/description/disclosure/heading"/>
    <xsl:apply-templates select="patent-document/description/disclosure/p"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/@id"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-problem"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-problem/@id"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-problem/heading"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-problem/p"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-solution"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-solution/@id"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-solution/heading"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/tech-solution/p"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/advantageous-effects"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/advantageous-effects/@id"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/advantageous-effects/heading"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/advantageous-effects/p"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/heading"/>
    <xsl:apply-templates select="patent-document/description/summary-of-invention/p"/>
    <xsl:apply-templates select="patent-document/description/description-of-drawings"/>
    <xsl:apply-templates select="patent-document/description/description-of-drawings/@id"/>
    <xsl:apply-templates select="patent-document/description/description-of-drawings/heading"/>
    <xsl:apply-templates select="patent-document/description/description-of-drawings/p"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/@id"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/embodiments-example"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/embodiments-example/@id"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/embodiments-example/@ex-num"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/embodiments-example/heading"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/embodiments-example/p"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/heading"/>
    <xsl:apply-templates select="patent-document/description/description-of-embodiments/p"/>
    <xsl:apply-templates select="patent-document/description/best-mode"/>
    <xsl:apply-templates select="patent-document/description/best-mode/@id"/>
    <xsl:apply-templates select="patent-document/description/best-mode/heading"/>
    <xsl:apply-templates select="patent-document/description/best-mode/p"/>
    <xsl:apply-templates select="patent-document/description/mode-for-invention"/>
    <xsl:apply-templates select="patent-document/description/mode-for-invention/@id"/>
    <xsl:apply-templates select="patent-document/description/mode-for-invention/heading"/>
    <xsl:apply-templates select="patent-document/description/mode-for-invention/p"/>
    <xsl:apply-templates select="patent-document/description/industrial-applicability"/>
    <xsl:apply-templates select="patent-document/description/industrial-applicability/@id"/>
    <xsl:apply-templates select="patent-document/description/industrial-applicability/heading"/>
    <xsl:apply-templates select="patent-document/description/industrial-applicability/p"/>
    <xsl:apply-templates select="patent-document/description/reference-signs-list"/>
    <xsl:apply-templates select="patent-document/description/reference-signs-list/@id"/>
    <xsl:apply-templates select="patent-document/description/reference-signs-list/heading"/>
    <xsl:apply-templates select="patent-document/description/reference-signs-list/p"/>
    <xsl:apply-templates select="patent-document/description/reference-to-deposited-biological-material"/>
    <xsl:apply-templates select="patent-document/description/reference-to-deposited-biological-material/@id"/>
    <xsl:apply-templates select="patent-document/description/reference-to-deposited-biological-material/heading"/>
    <xsl:apply-templates select="patent-document/description/reference-to-deposited-biological-material/p"/>
    <xsl:apply-templates select="patent-document/description/sequence-list-text"/>
    <xsl:apply-templates select="patent-document/description/sequence-list-text/@id"/>
    <xsl:apply-templates select="patent-document/description/sequence-list-text/heading"/>
    <xsl:apply-templates select="patent-document/description/sequence-list-text/p"/>
    <xsl:apply-templates select="patent-document/description/citation-list"/>
    <xsl:apply-templates select="patent-document/description/citation-list/@id"/>
    <xsl:apply-templates select="patent-document/description/citation-list/patent-literature"/>
    <xsl:apply-templates select="patent-document/description/citation-list/patent-literature/heading"/>
    <xsl:apply-templates select="patent-document/description/citation-list/patent-literature/p"/>
    <xsl:apply-templates select="patent-document/description/citation-list/non-patent-literature"/>
    <xsl:apply-templates select="patent-document/description/citation-list/non-patent-literature/heading"/>
    <xsl:apply-templates select="patent-document/description/citation-list/non-patent-literature/p"/>
    <xsl:apply-templates select="patent-document/description/citation-list/heading"/>
    <xsl:apply-templates select="patent-document/description/citation-list/p"/>
    <xsl:apply-templates select="patent-document/description/heading"/>
    <xsl:apply-templates select="patent-document/description/heading/@level"/>
    <xsl:apply-templates select="patent-document/description/heading/@id"/>
    <xsl:apply-templates select="patent-document/description/heading/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/b"/>
    <xsl:apply-templates select="patent-document/description/heading/b/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/i"/>
    <xsl:apply-templates select="patent-document/description/heading/i/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/u"/>
    <xsl:apply-templates select="patent-document/description/heading/u/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/o"/>
    <xsl:apply-templates select="patent-document/description/heading/o/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/sup"/>
    <xsl:apply-templates select="patent-document/description/heading/sup/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/sub"/>
    <xsl:apply-templates select="patent-document/description/heading/sub/text()"/>
    <xsl:apply-templates select="patent-document/description/heading/smallcaps"/>
    <xsl:apply-templates select="patent-document/description/heading/smallcaps/text()"/>
    <xsl:apply-templates select="patent-document/description/p"/>
    <xsl:apply-templates select="patent-document/claims"/>
    <xsl:apply-templates select="patent-document/claims/@id"/>
    <xsl:apply-templates select="patent-document/abstract"/>
    <xsl:apply-templates select="patent-document/abstract/@id"/>
    <xsl:apply-templates select="patent-document/abstract/@lang"/>
    <xsl:apply-templates select="patent-document/abstract/doc-page"/>
    <xsl:apply-templates select="patent-document/abstract/p"/>
    <xsl:apply-templates select="patent-document/drawings"/>
    <xsl:apply-templates select="patent-document/drawings/@id"/>
    <xsl:apply-templates select="patent-document/drawings/doc-page"/>
    <xsl:apply-templates select="patent-document/drawings/figure"/>
  ...
  <xsl:template match="parties/applicants/applicant/@sequence">
    <xsl:element name="pat:PartyBag/pat:ApplicantBag/pat:Applicant/pat:SuccessorRights/@pat:applicantSequenceNumberReference" namespace="http://www.wipo.int/standards/XMLSchema/ST96/Patent">
      <xsl:apply-templates select="@* | node()"/>
    </xsl:element>
  </xsl:template>
