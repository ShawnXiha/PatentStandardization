<xsl:stylesheet version="2.0"
		...
		<pat:ClaimText>
			<xsl:for-each select="$claimtext/node()">
				...
				<xsl:variable name="var1_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:ClaimText)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var3_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Bold)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var5_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Italic)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var7_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Overscore)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var9_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Underline)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var15_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Image)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var17_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:SmallCapitals)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var19_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:Break)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<xsl:variable name="var25_test_resultof_node_name_equal_qname" as="node()?">
					<xsl:if test="fn:boolean(self::*:TableDetails)">
						<xsl:sequence select="."/>
					</xsl:if>
				</xsl:variable>
				...
				<com:IPOASISTable>
					...
					<xsl:for-each select="*:Title">
						<com:TableTitle>
							...
							<xsl:for-each select="*:SmallCapitals">
												...
												<com:Entry>
													...
													<xsl:for-each select="node()">
														...
														<xsl:variable name="var22_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:UnorderedLists)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														...
														<xsl:variable name="var24_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:OrderedLists)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														...
														<xsl:variable name="var26_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:DefinitionList)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														<xsl:for-each select="$var26_test_resultof_node_name_equal_qname">
															<com:DL>
																...
																<xsl:for-each select="*:DefinitionDescription">
																	<com:DD>
																		<xsl:sequence select="fn:string(.)"/>
																	</com:DD>
																</xsl:for-each>
														...
														<xsl:for-each select="$var30_test_resultof_node_name_equal_qname">
															<com:ChemicalFormulae>
																...
																<xsl:for-each select="*:ChemicalPointer|*:FormulaText">
																	<com:InlineFormula>
																		<xsl:sequence select="()"/>
																	</com:InlineFormula>
																</xsl:for-each>
														...
														<xsl:variable name="var32_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:ApplicationCitation)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														...
														<xsl:variable name="var34_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:NPLCitation)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														...
														<xsl:variable name="var35_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:CrossReference)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														<xsl:for-each select="$var35_test_resultof_node_name_equal_qname">
														...
														<xsl:variable name="var50_test_resultof_node_name_equal_qname" as="node()?">
															<xsl:if test="fn:boolean(self::*:BiologicalDeposit)">
																<xsl:sequence select="."/>
															</xsl:if>
														</xsl:variable>
														<xsl:for-each select="$var50_test_resultof_node_name_equal_qname">
															<com:BioDeposit>
																...
																<xsl:for-each select="*:BioDepositary">
			...
			<com:PostalAddressBag>
				<com:PostalAddress>
					<com:PostalStructuredAddress>
						<xsl:for-each select="$var1_address/*:AddressLine">
							<com:AddressLineText>
								<xsl:attribute name="com:sequenceNumber" select="xs:string(xs:decimal(position()))"/>
							</com:AddressLineText>
						</xsl:for-each>
						<xsl:for-each select="$var1_address/*:AddressFloor">
							<com:AddressLineText>
								<xsl:attribute name="com:addressLineCategory" select="'Floor'"/>
							</com:AddressLineText>
						</xsl:for-each>
						<xsl:for-each select="$var1_address/*:PostBox">
							<com:AddressLineText>
								<xsl:attribute name="com:addressLineCategory" select="'Postal office box'"/>
							</com:AddressLineText>
						</xsl:for-each>
						<xsl:for-each select="$var1_address/*:AddressBuilding">
							<com:AddressLineText>
								<xsl:attribute name="com:addressLineCategory" select="'Building'"/>
							</com:AddressLineText>
						</xsl:for-each>
						<xsl:for-each select="$var1_address/*:AddressRoom">
							<com:AddressLineText>
	...
	<xsl:template name="WIPO:ST36dtToST96DT">
		...
		<com:DT>
			...
			<xsl:for-each select="$dt/*:Underline">
			...
			<xsl:for-each select="$dt/*:SmallCapitals">
	...
	<xsl:template name="WIPO:ST36imgToST96Image">
		...
		<com:Image>
			...
			<xsl:for-each select="$img/@imgContent">
			...
			<xsl:for-each select="$img/@imgFormat">
	...
	<xsl:template name="WIPO:ST36patcitToST96PatentCitation">
		...
		<com:PatentCitation>
			...
			<xsl:for-each select="$patcit//*:DocumentID">
				<com:CitedPatentDocumentIdentification>
					<xsl:for-each select="*:WIPOST3Code">
						<com:IPOfficeCode>
							<xsl:sequence select="fn:string(.)"/>
						</com:IPOfficeCode>
					</xsl:for-each>
			...
			<xsl:for-each select="$p/node()">
				...
				<xsl:for-each select="$var97_test_resultof_node_name_equal_qname">
					<com:BioDeposit>
						...
						<xsl:for-each select="*:BiologicalAccessionNumbero">
							<com:BiologicalAccessionNumber>
								<xsl:sequence select="fn:string(.)"/>
							</com:BiologicalAccessionNumber>
						</xsl:for-each>
						...
						<xsl:for-each select="*:DescriptiveText">
							<com:BioDepositText>
								<xsl:sequence select="fn:string(.)"/>
							</com:BioDepositText>
						</xsl:for-each>
	...
	<xsl:template name="WIPO:ST36bToST96B">
		...
		<com:B>
			<xsl:for-each select="$b/node()">
				<xsl:variable name="var47_resultof_node_name_equal_qname" as="xs:boolean" select="fn:boolean(self::*:Sub)"/>
				<xsl:if test="fn:boolean(self::text())">
					<xsl:sequence select="fn:string(.)"/>
				</xsl:if>
				<xsl:variable name="var1_test_resultof_node_name_equal_qname" as="node()?">
				...
				<xsl:for-each select="$var32_test_node_name_equal_qname">
					<xsl:variable name="var41_sup" as="node()*" select="$b/*:Sup"/>
					<com:Sup>
						<xsl:for-each select="(./node())[fn:boolean(self::text())]">
							<xsl:sequence select="fn:string(.)"/>
						</xsl:for-each>
						<xsl:for-each select="$var41_sup/*:Bold">
							<com:B>
								<xsl:for-each select="(./node())[fn:boolean(self::text())]">
									<xsl:sequence select="fn:string(.)"/>
								</xsl:for-each>
						...
						<xsl:for-each select="$var41_sup/*:Italic">
							<com:I>
								<xsl:for-each select="(./node())[fn:boolean(self::text())]">
									<xsl:sequence select="fn:string(.)"/>
								</xsl:for-each>
						...
						<xsl:for-each select="$var41_sup/*:o">
							<com:O>
								<xsl:for-each select="(./node())[fn:boolean(self::text())]">
									<xsl:sequence select="fn:string(.)"/>
								</xsl:for-each>
						...
						<xsl:for-each select="$var41_sup/*:Underline">
							<com:U>
								<xsl:for-each select="(./node())[fn:boolean(self::text())]">
									<xsl:sequence select="fn:string(.)"/>
								</xsl:for-each>
						...
						<xsl:for-each select="$var41_sup/*:sup2">
							<com:Sup2>
								<xsl:for-each select="node()">
									<xsl:if test="fn:boolean(self::text())">
										<xsl:sequence select="fn:string(.)"/>
						...
						<xsl:for-each select="$var41_sup/*:sub2">
							<com:Sub2>
								<xsl:for-each select="node()">
									<xsl:if test="fn:boolean(self::text())">
										<xsl:sequence select="fn:string(.)"/>
	...
	<xsl:template name="WIPO:ST36iToST96I">
		...
		<com:I>
			...
			<com:U>
				<com:B>
					<xsl:for-each select="$i/*:Underline">
	...
	<xsl:template name="WIPO:ST36bio-depositToST96BioDeposit-Bib">
		...
		<com:BioDeposit>
			...
			<xsl:for-each select="$biodeposit/*:term">
				<com:BioDepositTermText>
					<xsl:for-each select="$var1_depositary/*:address/*:text">
	...
	<xsl:template name="WIPO:ST36partiesToST96PartyBag">
		...
		<pat:PartyBag>
			<xsl:for-each select="$parties/*:ApplicantDetails">
				<pat:ApplicantBag>
						...
						<pat:Applicant>
							...
							<xsl:for-each select="*:AddressBook">
								<xsl:variable name="var1_resultof_ST__address_bookToST__PublicationContact" as="node()?">
									<xsl:call-template name="WIPO:ST36address-bookToST96PublicationContact3">
			...
			<xsl:for-each select="$parties/*:InventorDetails">
				<pat:InventorBag>
			...
			<xsl:for-each select="$parties/*:AgentDetails">
				...
				<pat:RegisteredPractitionerBag>
					<xsl:for-each select="*:Agent">
						<pat:RegisteredPractitioner>
							...
							<xsl:for-each select="$var10_cur/*:CustomerNumber">
								<pat:RegisteredPractitionerRegistrationNumber>
									<xsl:sequence select="fn:string(.)"/>
								</pat:RegisteredPractitionerRegistrationNumber>
							</xsl:for-each>
							<xsl:for-each select="@repType">
	...
	<xsl:template match="/">
		<xsl:variable name="var382_application_body" as="node()?" select="//*:PatentDocumentAndRelated"/>
		<xsl:variable name="var381_doc_page_of_application_body" as="node()*" select="$var382_application_body/*:DocPage"/>
		<xsl:variable name="var71_bibliographic_data" as="node()?" select="//*:BibliographicData"/>
	...
	<pat:PatentPublication com:languageCode="zh" com:st96Version="V3_1"
		...
		<pat:BibliographicData com:st96Version="V3_1">
			<xsl:for-each select="$var71_bibliographic_data">
				...
				<xsl:variable name="var2_publication_reference" as="node()" select="*:PublicationReference[1]"/>
				<xsl:variable name="var1_document_id" as="node()" select="$var2_publication_reference/*:DocumentID"/>
				<pat:PatentPublicationIdentification>
					<xsl:for-each select="$var2_publication_reference/@id">
						<xsl:attribute name="com:id" select="fn:string(.)"/>
					</xsl:for-each>
					<com:IPOfficeCode>
						<xsl:sequence select="fn:string($var1_document_id/*:WIPOST3Code)"/>
					</com:IPOfficeCode>
					<pat:PublicationNumber>
						<xsl:sequence select="fn:string($var1_document_id/*:DocNumber)"/>
					</pat:PublicationNumber>
				...
				<xsl:variable name="var6_application_reference" as="node()" select="*:ApplicationReference[1]"/>
				<xsl:variable name="var5_document_id" as="node()" select="$var6_application_reference/*:DocumentID"/>
				<xsl:variable name="var4_country_as_string" as="xs:string" select="fn:string($var5_document_id/*:WIPOST3Code)"/>
				<pat:ApplicationIdentification>
					...
					<com:ApplicationNumber>
						...
						<com:ApplicationNumberText>
							<xsl:sequence select="fn:string($var5_document_id/*:DocNumber)"/>
						</com:ApplicationNumberText>
					</com:ApplicationNumber>
					<xsl:for-each select="$var6_application_reference/@applType">
						<xsl:variable name="var3_resultof_vmf__inputtoresult" as="xs:string?">
					...
					<pat:PriorityClaimBag>
						<xsl:for-each select="*:Priority">
							<pat:PriorityClaim>
								...
								<com:IPOfficeCode>
									<xsl:sequence select="fn:string(*:WIPOST3Code)"/>
								</com:IPOfficeCode>
								<xsl:for-each select="*:DocNumber">
									<com:ApplicationNumber>
										<xsl:for-each select="(./node())[fn:boolean(self::text())]">
				...
				<pat:PatentClassificationBag>
					<xsl:for-each select="*:ClassificationIPC">
						<pat:IPCClassification>
							<xsl:for-each select="@id">
								<xsl:attribute name="com:id" select="fn:string(.)"/>
							</xsl:for-each>
							<com:Edition>
								<xsl:sequence select="fn:string(*:EditionStatement)"/>
							</com:Edition>
							<pat:MainClassification>
								<xsl:sequence select="fn:string(*:MainClassification)"/>
							</pat:MainClassification>
							<xsl:for-each select="*:FurtherClassification">
					...
					<xsl:for-each select="*:ClassificationIPCRDetails">
						<pat:IPCRClassificationBag>
							<xsl:for-each select="*:ClassificationIPCR">
				...
				<pat:InventionTitleBag>
					<xsl:for-each select="*:InventionTitle">
						<pat:InventionTitle>
							<xsl:for-each select="@id">
								<xsl:attribute name="com:id" select="fn:string(.)"/>
							</xsl:for-each>
				...
				<xsl:for-each select="*:ReferencesCited">
					...
					<pat:ReferenceCitationBag>
						...
						<xsl:for-each select="$var11_citation">
							<pat:ReferenceCitation>
								...
								<xsl:for-each select="*:ApplicationCitation">
									<com:PatentCitation>
										<xsl:for-each select="@id">
											<xsl:attribute name="com:id" select="fn:string(.)"/>
										</xsl:for-each>
										...
										<xsl:for-each select=".//*:DocumentID">
											<com:CitedPatentDocumentIdentification>
												...
												<com:DocumentNumber>
													<xsl:sequence select="fn:string(*:DocNumber)"/>
												</com:DocumentNumber>
												<xsl:for-each select="*:Name">
													<com:EntityName>
														<xsl:sequence select="fn:string(.)"/>
								...
								<xsl:for-each select="*:NPLCitation">
									<com:NPLCitation>
										<xsl:for-each select="@id">
											<xsl:attribute name="com:id" select="fn:string(.)"/>
										</xsl:for-each>
				...
				<xsl:variable name="var34_parties" as="node()" select="*:Parties"/>
		...
		<xsl:for-each select="$var382_application_body/*:Description">
			<pat:Description>
				...
				<xsl:for-each select=".//*:TechnicalField">
					<pat:TechnicalField>
						<xsl:for-each select="@id">
							<xsl:attribute name="com:id" select="fn:string(.)"/>
						</xsl:for-each>
				...
				<xsl:for-each select=".//*:BackgroundArt">
					<pat:BackgroundArt>
						<xsl:for-each select="@id">
							<xsl:attribute name="com:id" select="fn:string(.)"/>
						</xsl:for-each>
				...
				<xsl:for-each select=".//*:InventionSummary">
				...
				<xsl:for-each select=".//*:DrawingsDescription">
				...
				<xsl:for-each select=".//*:EmbodimentDescription">
				...
				<xsl:for-each select=".//*:InventionMode">
					<pat:InventionMode>
						<xsl:for-each select="@id">
							<xsl:attribute name="com:id" select="fn:string(.)"/>
						</xsl:for-each>
				...
				<xsl:for-each select=".//*:IndustrialApplicability">
		...
		<u>
				...
				<xsl:for-each select=".//*:ReferenceSignsList">
				...
				<xsl:for-each select=".//*:ReferenceToDepositedBiologicalMaterial">
				...
				<xsl:for-each select=".//*:SequenceListText">
				...
				<xsl:for-each select=".//*:CitationList">
					<com:CitationBag>
						<xsl:for-each select="@id">
							<xsl:attribute name="com:id" select="fn:string(.)"/>
						</xsl:for-each>
			...
			<pat:Drawings>
				...
				<xsl:for-each select="*:Figure">
					<pat:Figure>
						...
						<xsl:variable name="var379_img" as="node()" select="*:Image"/>
