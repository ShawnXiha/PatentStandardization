<xsl:stylesheet version="2.0" xmlns="http://www.wipo.int/standards/XMLSchema/ST96/Patent"
    ...
    <xsl:template name="WIPO:ST36partiesToST96PartyBag">
        ...
        <pat:PartyBag>
            <xsl:for-each select="$parties//*:applicants-agents">
                <pat:ApplicantBag>
            ...
            <xsl:for-each select="$parties//*:applicants-agents[agent]">
            ...
            <xsl:for-each select="$parties/*:correspondence-address[fn:namespace-uri() eq '']">
                <com:CorrespondenceAddress xmlns:com="http://www.wipo.int/standards/XMLSchema/ST96/Common">
                    ...
                    <xsl:for-each select="*:addressbook[fn:namespace-uri() eq '']">
                        <xsl:variable name="var12_resultof_ST__address_bookToST__contact" as="node()?">
                        ...
                        <xsl:for-each select="$var12_resultof_ST__address_bookToST__contact">
                            <com:Contact>
                                <xsl:sequence select="(./@node(), ./node())"/>
                            </com:Contact>
                        </xsl:for-each>
    ...
    <xsl:template name="vmf:vmf9_inputtoresult">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:copy-of select="'Agent'"/></xsl:otherwise>
    ...
    <xsl:template name="WIPO:ST36imgToST96Image">
        ...
        <com:Image>
            <xsl:for-each select="$img/@id">
                <xsl:attribute name="com:id" select="fn:concat('img-',fn:string(.))"/>
            </xsl:for-each>
    ...
    <xsl:template match="/">
        <xsl:variable name="var382_patent_application" as="node()?" select="//jp-official-gazette"/>
        ...
        <pat:PatentPublication com:languageCode="ja" com:st96Version="V3_1"
            ...
            <xsl:variable name="var71_bibliographic_data" as="node()?" select="//bibliographic-data"/>
            <pat:BibliographicData com:st96Version="V3_1">
                ...
                <xsl:for-each select="related-documents">
                    <pat:RelatedDocumentBag>
                        ...
                        <xsl:for-each select="*:change-of-utility">
                ...
                <xsl:for-each select="patent-family">
                    <pat:PatentFamily>
                        ...
                        <xsl:variable name="var41_priority_application" as="node()" select="priority-application"/>
                        <xsl:variable name="var40_document_id" as="node()"
                                      select="$var41_priority_application/document-id"/>
                        <xsl:variable name="var39_country_as_string" as="xs:string"
                                      select="fn:string($var40_document_id/country)"/>
                        <pat:PriorityApplication>
                            <pat:ApplicationIdentification>
                                <com:IPOfficeCode>
                                    <xsl:sequence select="$var39_country_as_string"/>
                                </com:IPOfficeCode>
                                <com:ApplicationNumber>
                                    <com:IPOfficeCode>
                                        <xsl:sequence select="$var39_country_as_string"/>
                                    ...
                                    <com:ApplicationNumberText>
                                        <xsl:sequence select="fn:string($var40_document_id/doc-number)"/>
                                    </com:ApplicationNumberText>
                                </com:ApplicationNumber>
                                <xsl:for-each select="$var40_document_id/date">
                                    <pat:FilingDate>
                                        <xsl:sequence select="fn:string(.)"/>
                                    </pat:FilingDate>
                                </xsl:for-each>
                            </pat:ApplicationIdentification>
                            <xsl:variable name="var38_document_id" as="node()" select="$var40_document_id"/>
                            <pat:PatentPublicationIdentification>
                                <com:IPOfficeCode>
                                    <xsl:sequence select="fn:string($var38_document_id/country)"/>
                                </com:IPOfficeCode>
                                <pat:PublicationNumber>
                                    <xsl:sequence select="fn:string($var38_document_id/doc-number)"/>
                                </pat:PublicationNumber>
                                <xsl:for-each select="$var38_document_id/kind">
                                    <com:PatentDocumentKindCode>
                                        <xsl:sequence select="fn:string(.)"/>
                                    </com:PatentDocumentKindCode>
                                </xsl:for-each>
                                <xsl:for-each select="$var38_document_id/date">
                                    <com:PublicationDate>
                                        <xsl:sequence select="fn:string(.)"/>
                                    </com:PublicationDate>
                                </xsl:for-each>
                        ...
                        <xsl:for-each select="family-member">
                            <xsl:variable name="var42_document_id" as="node()" select="document-id"/>
                            <pat:PatentFamilyMember>
                                <pat:PatentPublicationIdentification>
                                    <com:IPOfficeCode>
                                        <xsl:sequence select="fn:string($var42_document_id/country)"/>
                                    </com:IPOfficeCode>
                                    <pat:PublicationNumber>
                                        <xsl:sequence select="fn:string($var42_document_id/doc-number)"/>
                                    </pat:PublicationNumber>
                                    <xsl:for-each select="$var42_document_id/kind">
                                        <com:PatentDocumentKindCode>
                                            <xsl:sequence select="fn:string(.)"/>
                                        </com:PatentDocumentKindCode>
                                    </xsl:for-each>
                                    <xsl:for-each select="$var42_document_id/date">
                                        <com:PublicationDate>
                                            <xsl:sequence select="fn:string(.)"/>
                                        </com:PublicationDate>
                                    </xsl:for-each>
